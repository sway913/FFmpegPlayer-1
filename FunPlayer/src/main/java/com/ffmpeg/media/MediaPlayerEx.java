...
import com.ffmpeg.media.annotations.AccessedByNative;
...
public class MediaPlayerEx implements IMediaPlayer {
    ...
    public MediaPlayerEx() {
         ...
         */
        native_setup(new WeakReference<MediaPlayerEx>(this));
    }
    ...
    public void setWakeMode(Context context, int mode) {
        ...
        mWakeLock = pm.newWakeLock(mode | PowerManager.ON_AFTER_RELEASE, MediaPlayerEx.class.getName());
    ...
    private class EventHandler extends Handler {
        ...
        public EventHandler(MediaPlayerEx mp, Looper looper) {
            super(looper);
            mMediaPlayer = mp;
        }
                    ...
                    if (mOnTimedTextListener != null) {
                        if (msg.obj == null) {
                            ...
                            if (msg.obj instanceof byte[]) {
                                TimedTextEx text = new TimedTextEx(new Rect(0, 0, 1, 1), (String) (msg.obj));
    ...
    private static void postEventFromNative(Object mediaplayer_ref, int what, int arg1, int arg2, Object obj) {
        final MediaPlayerEx mp = (MediaPlayerEx) ((WeakReference) mediaplayer_ref).get();
        if (mp == null) {
            return;
        }
